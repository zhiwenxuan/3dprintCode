...
View3D = function(containerId) {
  ...
  var cameraZoom = 0;
  var rotate = false;
  var backgroundColor = '#dedede';  // 平台背景颜色
  var objectMaterial = 'solid';
  var objectColor = 0xffffff;    //物体颜色
  var showPlane = false;   // 是否显示工作平台
  var isWebGl = false;
  ...
  this.initScene = function() {
   ...
   //定义progressBar
    progressBar = document.createElement('div');  // 创建一个节点；Document 对象代表整个 XML 文档
