  ...
  function(
    ...
    var EditingDOMView = GeomVertexMV.EditingDOMView.extend({
      ...
      render: function() {
        ...
        var template =
          this.beforeTemplate +
          '<div>宽度 <input class="field width" type="text" value="{{width}}"></input></div>' +
          '<div>长度 <input class="field depth" type="text" value="{{depth}}"></input></div>' +
          '<div>高度 <input class="field height" type="text" value="{{height}}"></input></div>' +
          this.afterTemplate;
