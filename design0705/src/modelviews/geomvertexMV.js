      ...
      render: function() {
        ...
        this.afterTemplate = this.model.vertex.implicit ? '' :
          ...
          '<div class="transforms">' +
            '<div class="expander"><i class="arrow icon-caret-down"></i>位置朝向<i class="clear icon-remove"></i></div>' +
            ...
            '<div class="parameter">x轴 <input class="field axisx" type="text" value="{{axis.x}}"></input></div>' +
            '<div class="parameter">y轴 <input class="field axisy" type="text" value="{{axis.y}}"></input></div>' +
            '<div class="parameter">z轴 <input class="field axisz" type="text" value="{{axis.z}}"></input></div>' +
            '<div class="parameter">角度  <input class="field angle" type="text" value="{{angle}}"></input></div>' +
            '<div class="parameter">缩放  <input class="field scale" type="text" value="{{scale}}"></input></div>' +
          '</div>';
