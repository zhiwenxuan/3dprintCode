...
, toolbars: [["fullscreen","undo","redo","insertunorderedlist","insertorderedlist","selectall","cleardoc","pagebreak","insertimage","bold","italic","underline","fontborder","strikethrough","forecolor","backcolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","touppercase","tolowercase","directionalityltr","directionalityrtl","removeformat","formatmatch","autotypeset","customstyle","paragraph","rowspacingbottom","rowspacingtop","lineheight","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","inserttable","deletetable","splittocells","mergecells"]]
...
//        }
        ...
        ,initialStyle:'p{line-height:1em; font-size:14px; font-family:微软雅黑;}'//编辑器层级的基数,可以用来改变字体等
