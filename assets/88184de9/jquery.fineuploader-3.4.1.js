...
qq.FineUploaderBasic = function(o){
    ...
    this._options = {
        ...
        messages: {
            typeError: "使用了不正确的文件类型，目前仅支持{extensions}",
            sizeError: "{file}文件太大，请上传大小不要超过{sizeLimit}的文件",
            minSizeError: "{file}文件太小，请上传大小不要低于{minSizeLimit}",
            emptyError: "{file}为空，请重新选择",
            noFilesError: "没有文件被选中",
            tooManyItemsError: "上传文件数目超过限制，最多可上传{itemLimit}个文件",
            retryFailTooManyItems: "重试失败，你的操作已经达到上传上限",
            onLeave: "文件正在上传，如果离开本页将会视为放弃"
        },
        retry: {
            enableAuto: false,
            maxAutoAttempts: 2,
...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        text: {
            ...
            deleteButton: '删除',
            failUpload: '上传失败',
            dragZone: '将文件拖至此处开始上传',
            dropProcessing: '处理中...',
            formatProgress: "进度{percent}%",
        ...
        deleteFile: {
            forceConfirm: false,
            confirmMessage: "你确定删除文件 {filename}?",
