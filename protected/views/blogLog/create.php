...
<div class="m_left">
    ...
    <input id="tags" value="" name="tags" type="hidden">
    <input id="pic" value="" name="pic" type="hidden">
    <table class="m_table" cellpadding="0"  cellspacing="1">
    	<tr>
        	<td class="m_table_title"><span>*</span>标题:</td>
            <td><input id="title" class="m_ipt w_300" name="title" maxlength="50" type="text"><span class="form_msg">最多输入50个字符</span></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><textarea id="description" class="m_ipt w_700" name="description" maxlength="255" ></textarea></td>
        </tr>
        <tr>
        ...
        <tr>
        	<td colspan="2"><script id="editor" name="content" type="text/plain" class="m_ipt_content"></script></td>
        </tr>
        <tr>
