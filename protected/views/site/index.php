<?php
	if(Yii::app()->user->isGuest == false){  
		...
		if(isset($cookie['myInfo']->value)){
		$userInfo = $cookie['myInfo']->value;//------会员注册信息
		unset($cookie['myInfo']);	
		}
	}
?>
      ...
      <DIV class="twelve columns">
        <DIV id="header">
          <DIV id="slider-container">
            ...
            <IMG title="#htmlcaption1" alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/banner/images/3dimg1.jpg">
            <IMG title="#htmlcaption2" alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/banner/images/3dimg2.jpg">
            <IMG title="#htmlcaption3" alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/banner/images/3dimg3.jpg">
            <IMG title="#htmlcaption4" alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/banner/images/3dimg4.jpg">
            <IMG title="#htmlcaption5" alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/banner/images/3dimg5.jpg">
            </DIV>
            <!-- #slider -->
            <DIV id="htmlcaption1" class="nivo-html-caption"><SPAN class="sdate">3D打印工场
              ...
              <H1>迅速让您的想象变为现实...</H1>
              <HR>
              <P>您可以上传您的创意给我们，或者使用我们的网上设计平台，
              只需要仅仅几分钟，我们即可迅速实现您的创意。 </P>
            </DIV>
            
          <DIV id="htmlcaption2" class="nivo-html-caption"><SPAN class="sdate">在线3D设计技术
              </SPAN>
              <H1>在线3D模型设计系统...</H1>
              <HR>
              <P>简单易用的3D模型设计系统，即使是初学者也可以很快设计出想要的作品。 </P>
            </DIV>
            ...
            <DIV id="htmlcaption5" class="nivo-html-caption"><SPAN class="sdate">Ddayin.com
              </SPAN>
              <H1>帮助您保留美好回忆...</H1>
              <HR>
...
<!-- end #wrapper -->
    ...
    <div class="type_three">
        ...
        您只需提交您的3D设计给DDaYin.com，我们会在最短的时间内将实物邮寄给您。
        </div>
    ...
    <div class="type_three">
        ...
        <div class="index_three">只需简单一步，即可将您的3D设计展示在DDaYin.com的网上商城，轻松赚取大米。</div>
       <a href=""><img src="<?php echo Yii::app()->request->baseUrl; ?>/banner/images/makemoney.jpg" width="280" height="190"></a>
    </div>
    
    <div class="type_three_right">
     <div class="t_title">超易用的3D模型创作平台</div>
        <div class="index_three">若您想轻松创作一个3D作品，我们的网上3D设计中心将给您一种全新的体验。</div>
    ...
    <!--热门商品调用-->
    <!-- <?php 
    // echo $this->renderpartial('//product/hotproduct');
     ?> -->
    
    
     <!--最新商品调用-->
    <!-- <?php 
    //echo $this->renderpartial('//product/newproduct'); 
    ?> -->
