...
?>
    <a href="<?php 
			      if($action == "index"){
				  	echo $this->createUrl('product/manage', array('page'=>$onpage-1));
				  }
...
?>
	<a  href="<?php
    			   if($action == "index"){
				  	 echo $this->createUrl('product/manage', array('page'=>$i-1,'shelves'=>$shelves,'stat'=>$stat));
				   }
...
?>
    <a href="<?php 
			      if($action == "index"){
				  	echo $this->createUrl('product/manage', array('page'=>$onpage+1,'shelves'=>$shelves,'stat'=>$stat));
				  }
