...
<div style="float:left;">
    ...
    <span style="font-family:'微软雅黑'; font-size:20px;">购买记录</span>
    </div>
    ...
    <ul class="pageList">
        ...
        if ($onpage > 0) {
            ...
            <a href="<?php
            if ($action == "pBuys") {
                echo $this->createUrl('product/index', array('page' => $onpage - 1, 'stat' => $stat));
            }
        ...
        for ($i = 1; $i <= $pageALL; $i++) {
            ...
            <a  href="<?php
            if ($action == "pBuys") {
                echo $this->createUrl('product/index', array('page' => $i - 1, 'stat' => $stat));
            }
