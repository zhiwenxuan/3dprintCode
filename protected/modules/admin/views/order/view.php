      ...
      <div class="span12">
          ...
          <div class="portlet box grey">
              ...
              <div class="portlet-title">
                  <div class="caption"><i class="icon-reorder"></i>查看订单</div>
                  <div class="tools">
              ...
              <div class="control-group">
                  ...
                  <div class="controls">
                     <select id="order_stat" class="small m-wrap" tabindex="1" name="stat" disabled>
                        <option value=""  <?php if($dataProvider->order_stat == 1) echo 'selected="selected"'; ?>>&nbsp;待付款&nbsp;</option>
                        <option value="1" <?php if($dataProvider->order_stat == 2) echo 'selected="selected"'; ?>>&nbsp;已付款&nbsp;</option>
                        <option value="2" <?php if($dataProvider->order_stat == 4) echo 'selected="selected"'; ?>>&nbsp;交易成功&nbsp;</option>
                        <option value="2" <?php if($dataProvider->order_stat == 5) echo 'selected="selected"'; ?>>&nbsp;已取消&nbsp;</option>
                    </select>
                  </div>
              </div>
