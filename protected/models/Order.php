...
class Order extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('u_id, address, order_stat, add_id, edit_id', 'numerical', 'integerOnly'=>true),
			array('allPrice', 'length', 'max'=>15),
	...
	public function relations()
	{
		...
		return array(
			'buyer'=>array(self::BELONGS_TO,'Customer','u_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('allPrice',$this->allPrice,true);
